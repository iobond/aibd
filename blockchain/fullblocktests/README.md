...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/iobond/aibgo/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/iobond/aibgo/blockchain/fullblocktests
```
