...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/iobond/aibd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/iobond/aibd/blockchain/fullblocktests
```
