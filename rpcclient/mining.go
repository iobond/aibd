...
func (c *Client) SubmitBlockAsync(block *aibutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *aibutil.Block, options *btcjson.SubmitBlockOptions) error {
