...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/iobond/aibd/peer)
...
```bash
$ go get -u github.com/iobond/aibd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/iobond/aibd/peer#example-package--NewOutboundPeer)
